...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kudzucoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ny.kudzucoin.org", "ny.kudzucoin.org"},
    {"la.kudzucoin.org", "la.kudzucoin.org"},
    {"eu.kudzucoin.org", "eu.kudzucoin.org"},
    {"kudzupool.co.uk", "kudzupool.co.uk"},
    {"kudzu.kilovolt.co.uk", "kudzu.kilovolt.co.uk"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"kudzucoin.org", "testnet-seed.kudzucoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kudzucoin is probably already running."), addrBind.ToString().c_str());
        else
